...
def save_scores_csv(scores_acc, scores_kappa, scores_matthews_corrcoef, chunk_size, s_name, directory_to_save, neurons):
...
def read_and_run(stream_name, chunk_size, prep_methods, prep_methods_names, neurons=100, smoke_param=1,
    ...
    save_scores_csv(balanced_acc, kappa, matthews_corrcoef, chunk_size, stream_name, directory_to_save, neurons)
...
def start(m_methods, m_methods_names, m_streams_names, m_neurons, m_chunk_size=1500):
